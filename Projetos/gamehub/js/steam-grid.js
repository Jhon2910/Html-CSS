const SteamGridEngine = {
  ...
  obterCapaVertical(appId) {
    if (!appId) return "https://cdn.cloudflare.steamstatic.com/steam/apps/292030/library_600x900_2x.jpg";
    return `${this.CDN_BASE}/${appId}/library_600x900_2x.jpg`;
  },

  obterFundoHero(appId) {
    if (!appId) return "https://cdn.cloudflare.steamstatic.com/steam/apps/292030/page_bg_generated_v6b.jpg";
